-- ============================================================
-- Lager System - SQLite Datenbankschema
-- Entspricht 1:1 den bestehenden Excel-Tabellen (ListObjects)
-- Wird von db.py beim ersten Start automatisch ausgefuehrt
-- ============================================================
...
CREATE TABLE IF NOT EXISTS Artikel_Liste (
    ...
    Datum           TEXT NOT NULL,            -- ISO-Format, SQLite kennt kein natives DATETIME
...
-- (bisher per VBA-Schleife "Rowsuchen" durchsucht - jetzt per Index)
-- --------------------------------------------------------------
